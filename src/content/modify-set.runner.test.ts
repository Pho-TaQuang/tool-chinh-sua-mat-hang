...
import { ModifySetRunner } from "./modify-set.runner";
import type { ModifySetPreparedInput } from "./modify-set.types";
...
describe("ModifySetRunner", () => {
  it("runs create then mapping sequentially for multiple sets", async () => {
    ...
    const result = await runner.run(
      [createPrepared("one"), createPrepared("two")],
      {
  ...
  it("retries retryable errors using retryAfterMs", async () => {
